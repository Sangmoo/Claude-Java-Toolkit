...
## [4.4.0](https://github.com/Sangmoo/Claude-Java-Toolkit/compare/v4.3.0...v4.4.0) (2026-07-01)
...
* 8종 기능 추가 — CSV 내보내기·DB 회로차단기 공유·MCP 카드·연결 테스트·테스트 2종 ([d065993](https://github.com/Sangmoo/Claude-Java-Toolkit/commit/d0659938cd02a29de96321ea90ee086ef38444fa))
* 8종 기능 추가 Round 2 — 포트헬스·편집모달·선택CSV·쿼리이력·DataJpaTest·Gzip·Readiness ([d5958fd](https://github.com/Sangmoo/Claude-Java-Toolkit/commit/d5958fd703246e523b77b5eb4fec8408059377dc))
* **admin/health:** 시스템 헬스 대시보드 확장 — 인덱서/캐시/감사/오류 5종 신규 카드 ([bfc7fc6](https://github.com/Sangmoo/Claude-Java-Toolkit/commit/bfc7fc6e01727a427030b0a930a6b53e3a26c4b7))
* **analysis:** bulk story generation, package deps graph, impact analysis ([7e01765](https://github.com/Sangmoo/Claude-Java-Toolkit/commit/7e017653829ca3da4167db5405bc5a0efd9e9fce))
* **analysis:** 결과 후속 질문 패널 — Follow-up Q&A ([#4](https://github.com/Sangmoo/Claude-Java-Toolkit/issues/4)) ([c2b847b](https://github.com/Sangmoo/Claude-Java-Toolkit/commit/c2b847b221bca8898cdaa587792263fc3d07bbce))
* **analysis:** 분석 체이닝 — 결과 후 다음 단계 1-클릭 ([#2](https://github.com/Sangmoo/Claude-Java-Toolkit/issues/2)) ([f823499](https://github.com/Sangmoo/Claude-Java-Toolkit/commit/f8234998fcdefbf13a860cdc81f7df6736b873bc))
* **audit:** Settings 변경 감사 로그 ([#15](https://github.com/Sangmoo/Claude-Java-Toolkit/issues/15)) — 외부감사 대응 인프라 ([7e0b6a7](https://github.com/Sangmoo/Claude-Java-Toolkit/commit/7e0b6a7216ccb6b0215e025e87c4d6c43ab0d452))
...
* **cache:** 입력 정규화 + 4-arg key + hit rate + 적중 인디케이터 ([#18](https://github.com/Sangmoo/Claude-Java-Toolkit/issues/18)) ([eb8df60](https://github.com/Sangmoo/Claude-Java-Toolkit/commit/eb8df605d0fedb37f5f915616f6e07e6472b0bbf))
...
* **compliance:** Stage 1 — 한국 컴플라이언스 리포트 인프라 + 전자금융감독규정 ([af9a5b5](https://github.com/Sangmoo/Claude-Java-Toolkit/commit/af9a5b5fc45d2bc3c12617bf95c5efc7012a4b6f))
* **compliance:** Stage 2 — 나머지 3종 컴플라이언스 리포트 템플릿 활성화 ([df07bbc](https://github.com/Sangmoo/Claude-Java-Toolkit/commit/df07bbc690c27f8744669e4712afa782590da9b4))
* **compliance:** Stage 3 — Excel 내보내기 + AI 경영진 요약 + 인쇄용 PDF 보기 ([ba5ab16](https://github.com/Sangmoo/Claude-Java-Toolkit/commit/ba5ab16f0da36b420709713f43099f4bbab2958a))
* **compliance:** 영구 저장 이력 + 모달 팝업 (v4.7.0) + 문서 최신화 ([808fc8f](https://github.com/Sangmoo/Claude-Java-Toolkit/commit/808fc8f1f17b7a05d436bd36e2b80563bbaf6a08))
...
* **flow+ui:** chat handoff button, SpringUrlIndexer accuracy, warmup progress banner ([830e540](https://github.com/Sangmoo/Claude-Java-Toolkit/commit/830e540a31b97f7bb1d468ea6f10447e102abbfd))
...
* **flow:** SP flow analysis + MiPlatform XML reverse trace (Feature D & A) ([fc4645f](https://github.com/Sangmoo/Claude-Java-Toolkit/commit/fc4645f4a144e05aca6974ee06a763b58402d640))
...
* **harness/ui:** Phase D 프론트엔드 — 오류로그 RCA 4단계 UI ([a847265](https://github.com/Sangmoo/Claude-Java-Toolkit/commit/a84726524d3b690d62e56b3fa564fc745f56a1bf))
* **harness:** Phase A 공통 인프라 + Phase D 오류로그 RCA 하네스 백엔드 ([dc04756](https://github.com/Sangmoo/Claude-Java-Toolkit/commit/dc04756c91ac03f400eb9c5feccadd060d39d88a))
* **harness:** Phase B — SP→Java 마이그레이션 하네스 (4단계 파이프라인 + UI) ([407ce8d](https://github.com/Sangmoo/Claude-Java-Toolkit/commit/407ce8d1afb5a5bbf2783b30df63e5275578b9d7))
* **harness:** Phase C — Oracle SQL 성능 최적화 하네스 (4단계 + UI) ([d0874ad](https://github.com/Sangmoo/Claude-Java-Toolkit/commit/d0874ad20ddfe4d79f6c61b6b2d1cce2921b8602))
* **history:** 리뷰 이력 태깅 시스템 ([#12](https://github.com/Sangmoo/Claude-Java-Toolkit/issues/12)) ([044c82a](https://github.com/Sangmoo/Claude-Java-Toolkit/commit/044c82a91b24a7669b4ecdbbd936f1b98ec9b0d3))
...
* **insights:** 사용자/팀 인사이트 섹션 — /roi-report 페이지 확장 ([55b7872](https://github.com/Sangmoo/Claude-Java-Toolkit/commit/55b7872f5bb68aa7eb9ca8fafe60a46f500f255a))
* **livedb:** #G3 Phase 0 — SQL 안전 게이트 + DbProfile Live 토글 ([0c8e27f](https://github.com/Sangmoo/Claude-Java-Toolkit/commit/0c8e27fc16b2a170f53265b6f5182ead3d224c98))
* **livedb:** #G3 Phase 1 — Oracle Live Context Provider ([4fa5b13](https://github.com/Sangmoo/Claude-Java-Toolkit/commit/4fa5b130f2c94422461c81abfffbcf3a8ec44fe7))
* **livedb:** #G3 Phase 2 — 분석 페이지 Live DB 자동 첨부 + UI 통합 ([9518153](https://github.com/Sangmoo/Claude-Java-Toolkit/commit/95181538b54e014ea10549cc28fe35e4d44c8731))
* **livedb:** #G3 Phase 3 — PostgreSQL 11+ 지원 추가 ([59dc97c](https://github.com/Sangmoo/Claude-Java-Toolkit/commit/59dc97c82ab4db38170d08ddcfc67a2dfd97a935))
* **livedb:** #G3 Phase 4 — Oracle INVISIBLE INDEX 시뮬레이터 ([7fd8571](https://github.com/Sangmoo/Claude-Java-Toolkit/commit/7fd85710d7ffc1312c79859b8b7af8d2f3ec366d))
* **livedb:** #G3 Phase 5 — 운영 대시보드 + Rate limit + 회로차단기 ([28c74fe](https://github.com/Sangmoo/Claude-Java-Toolkit/commit/28c74fe8910aca31c8d6c9929c02268f433f80e0))
* **livedb:** #G3 보강 옵션 B — 캐시 invalidate + audit + UX + 운영 가이드 ([f744ae1](https://github.com/Sangmoo/Claude-Java-Toolkit/commit/f744ae142389a76c1030992da8f47c5e8a9108ff))
* **livedb:** DbProfilesPage Live 분석 토글 UI + ALL 권한 가이드 ([49d8146](https://github.com/Sangmoo/Claude-Java-Toolkit/commit/49d8146b6d7ff9d36a9d5da2f65cc4eb3fbf50cf))
* **livedb:** 글로벌 enabled 런타임 토글 + DISABLED 안내 UI 보강 ([9e14851](https://github.com/Sangmoo/Claude-Java-Toolkit/commit/9e148515646f0e1df0a037c679bde6c07e8060d5))
* **mcp:** #M3 Phase 3 — MCP Server 구현 (Node.js, 12 tools, stdio transport) ([b49b45a](https://github.com/Sangmoo/Claude-Java-Toolkit/commit/b49b45aaaf6c6d0665ac52296fbebc3a3fee6465))
* **mcp:** #M3 사내망 공유 — Streamable HTTP transport + Spring Boot launcher + Docker 분리 컨테이너 ([88c2f13](https://github.com/Sangmoo/Claude-Java-Toolkit/commit/88c2f13f78480e72e4ea98e7336e25564a519c24))
* **package:** externalize story prompt, Claude timeout, indexer config, optional /overview pagination ([7b606b4](https://github.com/Sangmoo/Claude-Java-Toolkit/commit/7b606b4ec7f0be9a15616f28eadfbf46f81ec777))
* **package:** v4.5 Package Analysis baseline + ADMIN guard on /refresh ([b380730](https://github.com/Sangmoo/Claude-Java-Toolkit/commit/b380730bab8d6fb0589532fc8a71aa083d12efad))
* **platform:** #M3 Phase 1 — API Key 인증 인프라 (멀티 키 + RBAC) ([fbcff0c](https://github.com/Sangmoo/Claude-Java-Toolkit/commit/fbcff0c4b591505906be2ef41d63614daa0377c7))
* **platform:** #M3 Phase 2 — 동기 분석 API v1 (POST /api/v1/analyze) ([f81b7d2](https://github.com/Sangmoo/Claude-Java-Toolkit/commit/f81b7d2b6470631717c96895a8297970113cc86a))
...
* **search:** 필터 + 정렬 + 매치 강조 — 검색 결과 정확도 향상 ([e26d0b9](https://github.com/Sangmoo/Claude-Java-Toolkit/commit/e26d0b925d5713008c0b9b9b7198eb4f14050747))
* **security:** ADMIN 2FA 필수화 + 보안 단위 테스트 24건 + SSE 스트리밍 테스트 CME flaky 수정 ([185e6c4](https://github.com/Sangmoo/Claude-Java-Toolkit/commit/185e6c4b905a27cdcc9af4156878965315bb5d6c))
...
* **ui+api:** admin cache stats, story markdown export, last-scan timestamp, project-map search ([7e0c0f0](https://github.com/Sangmoo/Claude-Java-Toolkit/commit/7e0c0f07f4f265407fc781b1ef64d27618f8ed88))
* **ui:** 분석 시작 버튼 옆 비용 미리보기 (Token Estimator) ([a125dcb](https://github.com/Sangmoo/Claude-Java-Toolkit/commit/a125dcb2a51478fd2b25f7ac30243e0ea175010b))
...
* **v4.6.1:** UX 패치 + 정확도/안정성 개선 + 사용자 가이드 추가 ([057cbaa](https://github.com/Sangmoo/Claude-Java-Toolkit/commit/057cbaa5bb4d880df550e0e712a2f4b524203094))
...
* **analysis:** SSE 줄바꿈 + 체이닝 dbProfileId + explain_plan 자동 채움 3건 ([7749f95](https://github.com/Sangmoo/Claude-Java-Toolkit/commit/7749f95995a5d396d7b3bc067771a1677c942b62))
...
* **compliance:** Stage 1 검증 — typeLabel 정적화 + 날짜 파싱 + 단위 테스트 9건 ([dd36e79](https://github.com/Sangmoo/Claude-Java-Toolkit/commit/dd36e79802dada81cf0969e6fa89537e654012f5))
* **dbprofile:** /test + /create 엔드포인트 추가 — DbProfilesPage 호환 ([91abea0](https://github.com/Sangmoo/Claude-Java-Toolkit/commit/91abea0bca04481c207c40024951f35ff84f66a2))
...
* **mcp:** McpServerLauncher Java 8 호환 — javax.annotation + Process.pid() reflection ([132c8b7](https://github.com/Sangmoo/Claude-Java-Toolkit/commit/132c8b77f3fb437502b4ea3482777a98774b92b5))
...
* **test:** @BeforeEach stub 메서드에 throws Exception 추가 — IOException 처리 ([dba585c](https://github.com/Sangmoo/Claude-Java-Toolkit/commit/dba585c256c403159abb2386a292dec7e8d0d2ae))
* **test:** SSE 스트리밍 테스트 — Mockito thenReturn 타입 long → int 수정 ([cad26eb](https://github.com/Sangmoo/Claude-Java-Toolkit/commit/cad26ebb7355637c03250c6b06c534b73dd05ab5))
...
* document v4.5 Package Analysis in README, landing page, CHANGELOG ([cfc9104](https://github.com/Sangmoo/Claude-Java-Toolkit/commit/cfc9104e1755c7018f578155706f606e7abf8a5a))
...
* **mcp:** #M3 Phase 4 — MCP 운영 가이드 + README + docs/index.html 갱신 ([edce2b3](https://github.com/Sangmoo/Claude-Java-Toolkit/commit/edce2b397a2202b089b1ddcc53068172a45d1bbf))
...
* README + landing page 최신화 — v4.6.0 하네스 파이프라인 확장 ([9e8e92f](https://github.com/Sangmoo/Claude-Java-Toolkit/commit/9e8e92fe97661885a266499edbd6764e248c2827))
...
* **harness:** SSE streaming + Impact 분석의 review_history 저장 회귀 테스트 ([a3a4e43](https://github.com/Sangmoo/Claude-Java-Toolkit/commit/a3a4e436f12555ac345275e85fec71539d4d4b80))
* **package:** controller smoke tests + story service unit tests ([df90aac](https://github.com/Sangmoo/Claude-Java-Toolkit/commit/df90aaca0c1ec668c23a397219a1315403b054d4))
