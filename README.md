...
웹 대시보드는 **사이드바 네비게이션** 구조로 총 **22가지 AI 도구** + 설정 + 이력/즐겨찾기 관리를 제공합니다.
...
#### 3-1. 실행계획 Before/After 비교 — `/explain/compare` ⭐ NEW (v0.9.0)
...
Spring MVC Controllers (claude-toolkit-ui)
    ...
    │  ExplainPlanController     /explain          단일 분석 + Before/After 비교 (v0.9) ★ UPDATED
