...
#### 3-2. SQL 성능 히스토리 대시보드 — `/explain/dashboard` ⭐ NEW (v1.2.0)
...
Spring MVC Controllers (claude-toolkit-ui)
    ...
    │  SseStreamController       /stream           SSE 스트리밍 허브 (explain_plan·sql_refactor 포함) ★ UPDATED
    │  ExplainPlanController     /explain          단일·스트리밍 분석 + Before/After 비교  ★ UPDATED
